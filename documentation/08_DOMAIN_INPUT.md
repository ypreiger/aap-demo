...
**SCM layout vs Controller “Project”:** see [10_PROJECTS_GIT_SYNC.md](10_PROJECTS_GIT_SYNC.md) — one synced repo contains many **`projects/<slug>/`** trees; surveys use **`project_name`** = **`<slug>`**.
