...
If Hub’s **browse** UI is empty despite a healthy Hub deployment, validate **published vs community** filters and **`community`** repo sync (**[02_COLLECTION_HUB.md](02_COLLECTION_HUB.md)**).
...
Details: [04_COLLECTION_REFERENCE.md](04_COLLECTION_REFERENCE.md).
