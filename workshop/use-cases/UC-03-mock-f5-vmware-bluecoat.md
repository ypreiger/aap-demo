...
Swap **`uri`** tasks for **`f5networks.f5_modules`**, **`community.vmware`**, real ProxySG automation once credentials exist — Galaxy collections for F5/VMware live in **`../../collections/requirements.yml`**; ProxySG alternatives in **`../../documentation/ANSIBLE_COLLECTIONS.md`**.
