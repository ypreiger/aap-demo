...
Tower resource operator manifests under `aap-yamls/tower/`, job templates, workflow DAGs, inventory/credential conventions, approvals, webhook notification templates pointing at **`email-plugin`**.
