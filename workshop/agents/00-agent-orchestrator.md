...
- **Client steps** stay in **`documentation/USECASE_INDEX.md`** + **`documentation/USECASE_*.md`** when adding or renaming flows (stub **`workshop/use-cases/README.md`** points there).
