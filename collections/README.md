...
Full checklist, pinning, Automation Hub substitutes, EE build notes: **[`../documentation/COLLECTION_REFERENCE.md`](../documentation/COLLECTION_REFERENCE.md)**.

If **Automation Hub** shows an **empty** **`/content/collections`** UI until Community is synced from Galaxy, mirror this file into Hub with **`../scripts/hub-sync-community-from-requirements.sh`** (see **[`../documentation/COLLECTION_HUB.md`](../documentation/COLLECTION_HUB.md)**).
